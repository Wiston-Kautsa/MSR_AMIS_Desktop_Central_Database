...
```text
Desktop Client -> API Server :8090 -> PostgreSQL Server :5432
```
...
```bash
curl http://SERVER_IP_OR_NAME:8090/actuator/health
```
...
2. Check `http://SERVER_IP_OR_NAME:8090/actuator/health` from the client PC.
